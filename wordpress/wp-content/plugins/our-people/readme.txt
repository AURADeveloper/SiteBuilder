...
Installing "Our People" can be done either by searching for "Our People" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
